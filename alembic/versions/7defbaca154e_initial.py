...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ESTUDIANTE', 'DOCENTE', 'ADMIN', name='userrole', create_type=False)
, nullable=True),
    ...
    sa.Column('type', sa.Enum('DOCUMENTO', 'RECURSO_RA', name='resourcetype', create_type=False), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
